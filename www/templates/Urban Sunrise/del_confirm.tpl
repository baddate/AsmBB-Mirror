...
|
  [case:[special:lang]|
    ...
    <div class="btn-bar">
      <input class="btn" type="submit" value="[case:[special:lang]|Delete|Изтрий|Удалить|Supprimer|Löschen]" >
      <a class="btn" href="!by_id">[case:[special:lang]|Cancel|Връщане|Отменить|Annuler|Abbrechen]</a>
