...
<form class="user_edit_info" method="post" enctype="multipart/form-data" action="/!avatar_upload/[url:[html:[UserName]]]">
...
<form class="user_edit_info" method="post" action="/!setskin/[url:[html:[UserName]]]">
  <h2>[const:hdrLang]</h2>
