...
<div class="login">
  <form class="login-block" method="post" target="_self" action="/!login">
    ...
    <input class="hidden" type="text" value="[special:referer]" name="backlink" id="backlink">
    <input type="checkbox" name="persistent" id="pr" value="1"><label for="pr">[const:lblPers]</label>
    <input class="hidden" type="text" value="[ticket]" name="ticket" id="ticket">
    <noscript>
       <input class="hidden" type="text" name="submit.x" value="0">
       <input class="hidden" type="text" name="submit.y" value="0">
    </noscript>
    <input type="image" name="submit" id="submit" value="Submit"><label class="submit btn" for="submit">[const:btnSubmit]</label>
  </form>
  <article>
    [const:helpLogin]
  </article>
